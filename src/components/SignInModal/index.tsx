...
export const SignInModal = ({ anchorElSignInModal, setAnchorElSignInModal }: SignInModalProps) => {
    ...
    return (
        <Menu
            id="login-modal"
            className={isAccessibility ? classes.logInModalContrast : classes.logInModal}
        ...
        >
            ...
            >
                <CustomTypography color={isAccessibility ? "#000" : "#221F52"} fontWeight={500} fontSize={20} component="p">
                    Faça Login            </CustomTypography>
                ...
                <ButtonBase sx={{
                    ...
                    <GoogleLogo />
                    <CustomTypography component="p" fontSize={16} color={isAccessibility ? "#000" : "#909090"}>Continuar com Google</CustomTypography>
                </ButtonBase>
            </Box>
        </Menu>
    )
